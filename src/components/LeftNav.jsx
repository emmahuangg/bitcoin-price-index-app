...
export const LeftNav = (props) => {
  return (
      <div className='w-full bg-none h-full rounded-xl'>
          <button onClick={props.handleUpdate} className='w-full bg-green shadow-lg rounded-full p-4 outline text-black font-bold text-2xl outline-green hover:bg-black hover:text-green transition-all duration-200'>Update Data</button>
